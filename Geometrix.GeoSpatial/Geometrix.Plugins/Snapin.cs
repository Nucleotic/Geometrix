...
namespace Geometrix.Plugins
{
    public class Snapin : Extension
    {
        ...
        private void AddMenuItems(IHeaderControl header)
        {
            ...
            //var alphaItem = new SimpleActionItem(SampleMenuKey, "Alpha", null) { Key = "kA" };
            ...
            //var item = new SimpleActionItem(SampleMenuKey, "submenu", "2", null);
            //header.Add(item);
